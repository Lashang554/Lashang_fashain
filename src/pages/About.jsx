  ...
  return (
    <div className="min-h-screen bg-theme py-12 px-4 sm:px-6 lg:px-20">
      <div className="card-theme max-w-5xl mx-auto rounded-2xl shadow-xl p-10 space-y-10">
        {/* Heading */}
        <h1 className="text-4xl font-bold text-center text-theme-primary">
          About <span className="text-[#F85606]">Lashang Fashion</span>
        </h1>

        {/* Intro */}
        <p className="text-theme-secondary text-lg leading-relaxed text-center">
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc pl-6 text-theme-secondary space-y-2">
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-4 text-theme-secondary text-base">
            <div>
        ...
        <div className="text-center pt-4">
          ...
          <Link to="/products">
            <button className="btn-primary font-semibold px-7 py-3 rounded-xl shadow-md transition-all duration-300">
              Start Shopping
            </button>
          </Link>
        </div>
